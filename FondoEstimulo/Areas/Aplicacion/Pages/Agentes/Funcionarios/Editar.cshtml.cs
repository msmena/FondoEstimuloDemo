...
namespace FondoEstimulo.Areas.Aplicacion.Pages.Agentes.Funcionarios
{
    public class EditModel : AgentesBasePageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(int? id, bool? saveChangesError = false)
        {
            ...
            Agente = await _context.AgentesFuncionarios.FirstOrDefaultAsync(m => m.AgenteID == id);
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            Agente agenteOriginal = await _context.AgentesFuncionarios.AsNoTracking().FirstOrDefaultAsync(m => m.AgenteID == Agente.AgenteID);
