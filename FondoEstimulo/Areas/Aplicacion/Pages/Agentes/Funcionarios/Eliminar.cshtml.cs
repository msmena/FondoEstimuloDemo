...
namespace FondoEstimulo.Areas.Aplicacion.Pages.Agentes.Funcionarios
{
    public class DeleteModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(int? id, bool? saveChangesError = false)
        {
            ...
            Agente = await _context.AgentesFuncionarios
        ...
        public async Task<IActionResult> OnPostAsync(int? id)
        {
            ...
            Agente = await _context.AgentesFuncionarios.AsNoTracking().FirstOrDefaultAsync(m => m.AgenteID == id);
            ...
            if (Agente != null)
            {
                try
                {
                    _context.AgentesFuncionarios.Remove(Agente);
