...
namespace FondoEstimulo.Areas.Aplicacion.Pages.Agentes.Comunes
{
    public class DeleteModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(int? id, bool? saveChangesError = false)
        {
            ...
            Agente = await _context.AgentesComun
        ...
        public async Task<IActionResult> OnPostAsync(int? id)
        {
            ...
            Agente = await _context.AgentesComun.AsNoTracking().FirstOrDefaultAsync(m => m.AgenteID == id);
            ...
            if (Agente != null)
            {
                try
                {
                    _context.AgentesComun.Remove(Agente);
