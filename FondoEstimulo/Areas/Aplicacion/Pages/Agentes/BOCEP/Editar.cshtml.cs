...
namespace FondoEstimulo.Areas.Aplicacion.Pages.Agentes.BOCEP
{
    public class EditModel : AgentesBasePageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(int? id, bool? saveChangesError = false)
        {
            ...
            Agente = await _context.AgentesBOCEP.FirstOrDefaultAsync(m => m.AgenteID == id);
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            Agente agenteOriginal = await _context.AgentesBOCEP.AsNoTracking().FirstOrDefaultAsync(m => m.AgenteID == Agente.AgenteID);
